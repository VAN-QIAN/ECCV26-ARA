...
def default_prompt_path():
    return os.path.join(os.path.dirname(__file__), "evqa_answer_leak_prompt.txt")


def default_output_jsonl_path():
    return os.path.join("results_answer_leak", "evqa_answer_leak.jsonl")


def default_output_csv_path():
    return os.path.join("results_answer_leak", "evqa_answer_leak.csv")
...
def main():
    parser = argparse.ArgumentParser(description="Audit answer leakage for EVQA.")
