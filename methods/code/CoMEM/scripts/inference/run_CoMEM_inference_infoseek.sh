...
SCRIPT_PATH="CoMEM-inference/infoseek/run_infoseek_finetunekv_clip_customized.py"
OUTPUT_DIR="CoMEM-inference/infoseek/fixed_output" # Change this to your desired output directory
