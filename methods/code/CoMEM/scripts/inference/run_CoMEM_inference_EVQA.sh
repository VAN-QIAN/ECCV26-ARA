...
SCRIPT_PATH="CoMEM-inference/EVQA/run_EVQA_finetunekv_clip_customized.py"
OUTPUT_DIR="CoMEM-inference/EVQA/fixed_output" # Change this to your desired output directory
SIMILAR_NUM=10 # Number of relevant image-text pairs to retrieve


chmod +x $SCRIPT_PATH
echo "Running finetune CoMEM inference..."
CUDA_VISIBLE_DEVICES=2,3 python $SCRIPT_PATH --model_name $MODEL_NAME --output_dir $OUTPUT_DIR --similar_num $SIMILAR_NUM --checkpoint_path $CHECKPOINT_PATH
