...
SCRIPT_PATH="/data2/QianMa/ECCV/CoMEM/CoMEM-inference/infoseek/run_infoseek_finetunekv_clip_customized_unfixed.py"
OUTPUT_DIR="CoMEM-inference/infoseek/unfixed_output" # Change this to your desired output directory
SIMILAR_NUM=10 # Number of relevant image-text pairs to retrieve


chmod +x $SCRIPT_PATH
echo "Running finetune CoMEM inference..."
CUDA_VISIBLE_DEVICES=1,4 python $SCRIPT_PATH --model_name $MODEL_NAME --output_dir $OUTPUT_DIR --similar_num $SIMILAR_NUM --checkpoint_path $CHECKPOINT_PATH
