...
DEFAULT_METADATA_PATH = CAMERA_READY_ROOT / "data/ground_truth/evqa_unfixed_test_with_id.csv"
DEFAULT_MDS_DIR = SCRIPT_DIR / "Custom_test_full_unfixed"
...
def resolve_query_image_path(item):
...
def load_and_process_image(item):
    ...
    path = resolve_query_image_path(item)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="CoMEM-inference/EVQA/result", help="output directory")
